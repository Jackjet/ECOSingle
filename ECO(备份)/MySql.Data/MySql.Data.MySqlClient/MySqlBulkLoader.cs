...
namespace MySql.Data.MySqlClient
{
	public class MySqlBulkLoader
	{
		...
		{
			return Task.Factory.StartNew<int>(() => this.Load());
		}
		private string BuildSqlCommand()
		{
			...
			{
				if (this.Priority == MySqlBulkLoaderPriority.Concurrent)
				{
			...
			{
				if (this.ConflictOption == MySqlBulkLoaderConflictOption.Replace)
				{
