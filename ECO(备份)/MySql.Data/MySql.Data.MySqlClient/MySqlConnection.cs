...
namespace MySql.Data.MySqlClient
{
	...
	public sealed class MySqlConnection : DbConnection, IDisposable, ICloneable
	{
		...
		public new MySqlTransaction BeginTransaction(System.Data.IsolationLevel iso)
		{
			...
			{
				if (iso != System.Data.IsolationLevel.RepeatableRead)
				{
		...
		{
			return this.BeginTransactionAsync(System.Data.IsolationLevel.RepeatableRead);
		}
		public Task<MySqlTransaction> BeginTransactionAsync(System.Data.IsolationLevel iso)
		{
			return Task.Factory.StartNew<MySqlTransaction>(() => this.BeginTransaction(iso));
		}
		...
		{
			return Task.Factory.StartNew<MySqlSchemaCollection>(() => this.GetSchemaCollection(collectionName, restrictionValues));
		}
