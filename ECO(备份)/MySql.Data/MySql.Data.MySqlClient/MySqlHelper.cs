...
namespace MySql.Data.MySqlClient
{
	public sealed class MySqlHelper
	{
		...
		{
			return Task.Factory.StartNew<int>(() => MySqlHelper.ExecuteNonQuery(connection, commandText, commandParameters));
		}
		...
		{
			return Task.Factory.StartNew<int>(() => MySqlHelper.ExecuteNonQuery(connectionString, commandText, commandParameters));
		}
		public static Task<DataSet> ExecuteDatasetAsync(string connectionString, string commandText)
		{
			return MySqlHelper.ExecuteDatasetAsync(connectionString, commandText, null);
		}
		...
		{
			return Task.Factory.StartNew<DataSet>(() => MySqlHelper.ExecuteDataset(connectionString, commandText, commandParameters));
		}
		public static Task<DataSet> ExecuteDatasetAsync(MySqlConnection connection, string commandText)
		{
			return MySqlHelper.ExecuteDatasetAsync(connection, commandText, null);
		}
		...
		{
			return Task.Factory.StartNew<DataSet>(() => MySqlHelper.ExecuteDataset(connection, commandText, commandParameters));
		}
		...
		{
			return MySqlHelper.ExecuteReaderAsync(connectionString, commandText, null);
		}
		public static Task<MySqlDataReader> ExecuteReaderAsync(MySqlConnection connection, string commandText)
		{
			return MySqlHelper.ExecuteReaderAsync(connection, null, commandText, null, true);
		}
		...
		{
			return MySqlHelper.ExecuteReaderAsync(connection, null, commandText, commandParameters, true);
		}
		public static Task<object> ExecuteScalarAsync(string connectionString, string commandText)
		{
			return MySqlHelper.ExecuteScalarAsync(connectionString, commandText, null);
		}
		...
		{
			return Task.Factory.StartNew<object>(() => MySqlHelper.ExecuteScalar(connectionString, commandText, commandParameters));
		}
		public static Task<object> ExecuteScalarAsync(MySqlConnection connection, string commandText)
		{
			return MySqlHelper.ExecuteScalarAsync(connection, commandText, null);
		}
		...
		{
			return Task.Factory.StartNew<object>(() => MySqlHelper.ExecuteScalar(connection, commandText, commandParameters));
		}
	}
}
