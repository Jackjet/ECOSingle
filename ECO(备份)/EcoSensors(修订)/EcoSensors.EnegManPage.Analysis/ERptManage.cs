...
{
	public class ERptManage : UserControl
	{
		...
		{
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(ERptManage));
